...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/odd-water-1d34)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/odd-water-1d34
```

A live public deployment of this template is available at [https://odd-water-1d34.templates.workers.dev](https://odd-water-1d34.templates.workers.dev)
